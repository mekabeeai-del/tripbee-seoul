...
class IntentClassifier:
    ...
    def __init__(self, openai_api_key: str):
        ...
        self.prompt_file = Path(__file__).parent / "system_prompt.txt"
        ...
        self.functions = [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "location_keyword": {
                            "type": "string",
                            "description": "장소/지역 키워드 (명시적으로 언급된 경우만)"
                        },
                        "category_text": {
                            "type": "string",
                            "description": "카테고리 텍스트. 우선순위: 1.음식메뉴(우동,라멘,파스타등) 2.음식점종류(일식집,양식집등) 3.일반(맛집,카페등). '우동 맛집'→'우동', '라멘 맛집'→'라멘', '일식 맛집'→'일식집', '맛집'→'맛집'"
                        },
                        "emotion": {
                            "type": "string",
